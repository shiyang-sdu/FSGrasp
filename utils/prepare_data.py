...
def prepare_occupancy_grids(object_name, config, binvoxes_dir, output_dir):
  ...
  offset = (grid_size/2.0 - mid).astype(np.int_)
  ijk += offset
...
def prepare_all_data(session_nums, config, binvoxes_dir,
  ...
  # prepare_surface_normals('airplane', binvoxes_dir,
  ...
  # prepare_occupancy_grids('airplane', config, binvoxes_dir, this_output_dir)
